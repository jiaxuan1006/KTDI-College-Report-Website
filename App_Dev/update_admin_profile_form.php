...
if ($_SESSION["LEVEL"] == 0) { 	//only user with access level 0 (admin) can view
	...
	<body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-white w3-card" id="myNavbar">
                ...
                <a href="admin-main.php#about" class="w3-bar-item w3-button"><i class="fa fa-info-circle"></i> ABOUT</a>
                <!-- <a href="admin-main.php#team" class="w3-bar-item w3-button"><i class="fa fa-user"></i> TEAM</a> -->
                <a href="admin-main.php#work" class="w3-bar-item w3-button"><i class="fa fa-th"></i> WORK</a>
        ...
        <nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
            ...
            <a href="admin-main.php#about" onclick="w3_close()" class="w3-bar-item w3-button">ABOUT</a>
            <!-- <a href="admin-main.php#team" onclick="w3_close()" class="w3-bar-item w3-button">TEAM</a> -->
            <a href="admin-main.php#work" onclick="w3_close()" class="w3-bar-item w3-button">WORK</a>
            <a href="update_admin_profile_form.php?id=<?php echo "$_SESSION[USERID]"; ?>" onclick="w3_close()" class="w3-bar-item w3-button">PROFILE</a>
...
<table border="0" cellspacing="5" cellpadding="0" class="w3-table" style="width:fit-content;">
	...
	<tr>
		<td><button type="button" name="Back" class="w3-button w3-light-grey form-control" onclick="document.location='admin-main.php'">Back</td>
...
<?php
    ...
    echo "<p><a href='resident-main.php'>Go back to main page</a></p>";
